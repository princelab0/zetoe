...
} from "@/components/home/web-research/message";
import RelatedQuestions from "@/components/home/web-research/related-questions";
import {
  SearchResultsSkeleton,
  SearchResults,
} from "@/components/home/web-research/search-results";
import { Section } from "@/components/home/web-research/section";
...
export function ErrorMessage({ content }: { content: string }) {
  return (
    <Alert className='bg-red-500/5 border-red-500/15 p-5 mb-10'>
