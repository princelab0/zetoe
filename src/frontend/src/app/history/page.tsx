...
import { ErrorMessage } from "@/components/home/web-research/assistant-message";
import RecentChat from "@/components/home/history/recent-chat";
...
export default function RecentsPage() {
  ...
  return (
    <div className='h-screen '>
      <div className='mx-auto max-w-3xl pt-[72px] px-4 pb-16'>
