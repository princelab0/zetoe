...
export const metadata: Metadata = {
  ...
  description: "Princelab Terms of Use & Legal Information",
};
  ...
  return (
    <div className='min-h-screen bg-[var(--background)] text-[var(--foreground)] py-12 pt-[72px] px-4 sm:px-6 lg:px-8'>
      <div className='max-w-3xl mx-auto'>
          ...
          <div className='px-4 py-5 sm:p-6 space-y-6'>
            <section>
              ...
              <p className='text-gray-600 dark:text-gray-400 text-justify '>
                ...
                by using or visiting our Website, you are bound to these Terms
                and you indicate your continued acceptance of these Terms.
              </p>
            </section>
            <section>
              <h2 className='text-xl font-semibold text-gray-800 dark:text-gray-200 mb-2'>
            ...
            <section>
              ...
              <p className='text-gray-600 dark:text-gray-400 text-justify'>
               Zetoe has not reviewed, and cannot review, all of the
                ...
                offensive, indecent, or otherwise objectionable, as well as
                content containing technical inaccuracies, typographical
                mistakes, and other errors. The Website may also contain
                material that violates the privacy or publicity rights, or
            ...
            <section>
              ...
              <p className='text-gray-600 dark:text-gray-400 text-justify'>
                ...
                attention, you must provide our DMCA Agent with the following
                ...
                and the location on the Website of the allegedly infringing
                work; (c) a written statement that you have a good faith belief
                that the disputed use is not authorized by the owner, its agent
                or the law; (d) your name and contact information, including
                telephone number and email address; and (e) a statement by you
                that the above information in your notice is accurate and, under
            ...
            <section>
              ...
              <p className='text-gray-600 dark:text-gray-400 text-justify'>
                ...
                and with any other applicable policy or terms and conditions.
              </p>
            </section>
            <section>
              <h2 className='text-xl font-semibold text-gray-800 dark:text-gray-200 mb-2'>
              ...
              <p className='text-gray-600 dark:text-gray-400 text-justify'>
                ...
                to defend, indemnify, and hold each other harmless, including
                its subsidiaries and affiliates, their respective directors,
                officers, employees or agents, and other representatives, from
                and against all claims, losses, damages, liabilities, and costs
                (including but not limited to reasonable attorneys&apos; fees
                and court costs), arising out of, relating to or in connection
                with (i) a material violation of these Terms, or any agreement
                between the Parties, or (ii) any allegation that any information
                or material (including any Content) violates any rights of any
                third party. <br />
                <br /> You understand and agree that, by using the Products
            ...
            <section>
              ...
              <p className='text-gray-600 dark:text-gray-400 text-justify'>
                ...
                its risks hereunder, including but not limited to a general- and
                product liability insurance. Regarding the security,
                confidentiality and integrity of data, each party is responsible
                for maintaining appropriate technical and organizational
                measures for the protection of data processed on their own
                systems and on third party systems that are in use by the
                involved party.
                <br />
                <br />
            ...
            <section>
              <p className='text-gray-600 dark:text-gray-400 text-justify'>
                ...
                <Link
                  href='mailto:contactus@princelab.org'
                  className='text-blue-600 hover:underline'
                >
                  contactus@princelab.org
                </Link>
              </p>
            </section>
          </div>
        ...
        <p className='mt-4 text-centre text-sm text-gray-600 dark:text-gray-400 text-justify'>
